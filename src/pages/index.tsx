...
const Home: NextPage = () => {
  ...
  return (
    <>
      ...
      <main className="flex min-h-screen flex-col gap-12 bg-slate-800 items-center">
        <h1 className="mt-12 pl-4 text-4xl">Items for Sale</h1>
        <div className="container grid grid-cols-3 items-center justify-center gap-4 p-4">
